...
# Preferred: run a checked-in experiment manifest that freezes tasks, task groups, conditions, repetitions, primary metric, effect threshold, budget, and stopping rule.
